...
import { updateOneReubication } from "../../api/reubications";
import { getUsers } from "../../api/user";
export default function EditReubicate(props) {
  const { editItem, setEditItem, reload, setReload } = props;
  ...
  const onSubmit = async (data) => {
    ...
    const response = await updateOneReubication(auth, object);
